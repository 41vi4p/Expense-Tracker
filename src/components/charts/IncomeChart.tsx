...
export default function IncomeChart({ transactions, type = 'pie' }: IncomeChartProps) {
    ...
    if (active && payload && payload.length) {
      ...
      return (
        <div className="backdrop-blur-glass border border-border/50 rounded-xl p-3 shadow-xl">
          ...
          <p className="text-success font-display font-bold">{data.formattedValue}</p>
    ...
    return (
      <div className="h-64 flex items-center justify-center text-foreground/60">
        <div className="text-center">
          ...
          <p className="font-body">No income data available</p>
        </div>
      </div>
    );
  }
